...
ALTER TABLE media_items ADD COLUMN IF NOT EXISTS code VARCHAR(64);
ALTER TABLE media_items ADD COLUMN IF NOT EXISTS actor_id BIGINT;
ALTER TABLE media_items ADD COLUMN IF NOT EXISTS issue_date DATE;
